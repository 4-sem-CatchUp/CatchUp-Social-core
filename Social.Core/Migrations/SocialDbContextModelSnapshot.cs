...
namespace Social.Migrations
{
    ...
    {
        /// <summary>
        /// Configures the Entity Framework Core model snapshot for SocialDbContext, defining the entities, their properties, keys, indices, table mappings, and relationships.
        /// </summary>
        /// <param name="modelBuilder">The ModelBuilder used to construct the model representation captured by this snapshot.</param>
